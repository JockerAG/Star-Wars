...
export const BtnFav = () => {
    ...
    return (
        <div className="dropdown me-3">
            <button className="btn btn-warning text-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                Favorites
            ...
            <ul className="dropdown-menu dropdown-menu-dark dropdown-menu-lg-end">
                {myFavorites.length === 0 ? (
                    ...
                    myFavorites.map((item, id) => (
                        <li key={id} className="d-flex align-items-center mt-2">
                            <span className="dropdown-item">{item}</span>
                            <button type="button" className="btn btn-outline-danger"
                                onClick={() => actions.deleteFav(item, myFavorites)}>
